...
const SportsOutdoorsPage = ({ products, loading }) => {
  if (loading) return <div className="flex-status">Loading Sports & Outdoors...</div>;
  return (
    <div className="flex-page-container">
      <h2 className="section-title">Sports & Outdoors</h2>
