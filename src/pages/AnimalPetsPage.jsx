...
const AnimalPetsPage = ({ products, loading }) => {
  if (loading) return <div className="flex-status">Loading Animal Supplies...</div>;
  return (
    <div className="flex-page-container">
      <h2 className="section-title">Animal & Pets</h2>
